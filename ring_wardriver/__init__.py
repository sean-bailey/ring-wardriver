...
from ring_wardriver.utils import _exists_cache, _save_cache, _read_cache

from ring_wardriver.const import (
...
from ring_wardriver.doorbot import RingDoorBell
from ring_wardriver.chime import RingChime
from ring_wardriver.stickup_cam import RingStickUpCam
from ring_wardriver.proxycycler import _get_proxies, _get_valid_proxy
...
class Ring(object):
    ...
    def __init__(self, username, password, debug=False, persist_token=False,
                 ...
                 cache_file=CACHE_FILE, select_proxy=False):
        ...
        if self.select_proxy is True:
            self.workingproxy = _get_valid_proxy()
            self.proxydict = {'http': self.workingproxy, 'https': self.workingproxy}
            self.session.proxies = self.proxydict
    ...
    def query(self,
        ...
        while loop <= attempts:
            ...
            try:
                ...
                # this should load a new proxy each request made
                if method == 'GET':
